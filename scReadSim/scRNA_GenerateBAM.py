...
def scRNA_GenerateBAMCoord_ExonOnly(bed_file, UMI_count_mat_file, synthetic_cell_label_file, INPUT_bamfile, isoform_proportion_file, trancriptome_file, outdirectory, read_bedfile_prename, OUTPUT_cells_barcode_file, UMI_tag='UB:Z', read_len=126, UMI_len=10):
