...
# Tools directory
# This should be changed into import modules
script_directory = "/home/gayan/Projects/scATAC_Simulator/scripts/01242022_package_v1/scReadSim/"
...
genome_file = "/home/gayan/Projects/scATAC_Simulator/data/mm10_ref_genome_GECODE/mm10.chrom.sizes.removed"
Utility.scATAC_CreateFeatureSets(bedtools_directory, outdirectory, genome_file, ref_peakfile, ref_comple_peakfile, MACS3_peakname_pre)
...
scATAC_GenerateBAM.scATAC_GenerateBAMCoord(outdirectory, coordinate_file, ref_peakfile, synthetic_countmat_file, BED_filename_pre, OUTPUT_cells_barcode_file)
scATAC_GenerateBAM.scATAC_GenerateBAMCoord(outdirectory, coordinate_file, ref_comple_peakfile, synthetic_countmat_file_comple, BED_COMPLE_filename_pre, OUTPUT_cells_barcode_file)
